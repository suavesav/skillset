...
name: voice-agent
type: AGENT
description: Judges dialogue and player-facing lines against the owning title's voice bible — per-line verdicts with the violated rule quoted, at most one suggested fix per failure
knowledge:
  - "[[voice-bibles]]"
mcp: []
assets: []

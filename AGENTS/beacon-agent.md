...
name: beacon-agent
type: AGENT
description: Queries the Beacon UA and store-analytics platform — channel spend, installs, CPI, ROAS, creative performance, storefront impressions and conversion — with attribution windows respected and thin cells flagged
knowledge:
  - "[[ua-benchmarks]]"
mcp:
  - beacon-ua

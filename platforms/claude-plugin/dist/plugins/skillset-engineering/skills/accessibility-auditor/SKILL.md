---
description: >
  Audit a screen or feature against the Gladewick accessibility checklist — pass, fail, or needs-hardware-test per item, with remediation cited from the standard.
---

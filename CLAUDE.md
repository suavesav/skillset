...
This is a shareable, version-controlled library of AI skills, agents, and knowledge for Gladewick Games, a game development studio. It is platform-agnostic — the same files work across Claude Code, Claude Desktop, OpenAI Codex, and any AI tool that reads markdown.

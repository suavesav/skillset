---
name: matchmaking-analyst
type: SKILL
description: >
  Diagnose the queue-time vs match-quality trade-off in Emberwake matchmaking —
  measure both sides before touching a knob, and stay inside policy.
teams:
  - liveops
knowledge:
  - "[[matchmaking-policy]]"

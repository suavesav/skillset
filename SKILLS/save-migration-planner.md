---
name: save-migration-planner
type: SKILL
description: >
  Plan a save-format migration between builds — schema deltas, migration
  strategy, corrupted-save fallback, and the compatibility matrix. Real schemas only.
teams:
  - engineering
knowledge:
  - "[[save-format]]"
...
mcp: []
triggers:
  - "plan the save migration"
  - "we changed the save schema"
  - "will old saves break"
assets: []
---

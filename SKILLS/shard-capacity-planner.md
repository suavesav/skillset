---
name: shard-capacity-planner
type: SKILL
description: >
  Forecast the shard fleet for a launch or event — pre-scale date, peak fleet,
  headroom, scale-down — with stated assumptions and the metric that would invalidate them.
teams:
  - liveops
  - engineering
knowledge:
...
mcp:
  - opsdeck
triggers:
  - "how many shards for launch"
  - "will we hold at season start"
  - "capacity plan"
assets: []
---

...
type: SKILL
description: >
  Investigate a co-op desync from replay bundles — find the divergence tick,
  classify the cause class, and size the blast radius before calling severity.
teams:
  - engineering
knowledge:
  - "[[replay-format]]"
...
mcp:
  - kiln-replay
triggers:
  - "players report desync"
  - "co-op is out of sync"
  - "investigate this desync bundle"
assets: []
---

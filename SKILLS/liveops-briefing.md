---
name: liveops-briefing
type: SKILL
description: >
  The standing daily brief for both titles — yesterday against the 7-day baseline
  on population, stability, and fleet, anomalies first.
teams:
  - liveops
knowledge:
  - "[[telemetry-schema]]"
...
triggers:
  - "morning briefing"
  - "how are the games doing today"
  - "liveops health check"
---

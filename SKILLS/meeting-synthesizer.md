...
type: SKILL
description: >
  Turn a meeting transcript or raw notes into studio meeting notes — decisions,
  owned and dated actions, open questions, and what was explicitly not decided.
teams:
  - all
knowledge:
  - "[[studio-comms-format]]"
...
triggers:
  ...
  - "turn these notes into meeting notes"

...
name: revenue-model
type: KNOWLEDGE
description: How Gladewick makes money — prices, attach and conversion targets, ARPDAU by region tier, the quarter's per-title plan, where bookings live, and the booked-vs-recognized rule
---

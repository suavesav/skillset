...
name: replay-format
type: KNOWLEDGE
description: Kiln desync bundle anatomy — per-tick subsystem checksums, dual input streams, the 900-tick pre-divergence window — and how divergence is located
---

---
name: matchmaking-policy
type: KNOWLEDGE
description: Emberwake matchmaking — the non-tradeable hard constraints, the tunable middle, numbered fairness bands, and the small-region exception process
---

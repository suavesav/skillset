...
name: save-format
type: KNOWLEDGE
description: Save schema versioning for both titles — the sv7–sv11 ladder, migrate-on-load vs versioned-reader rule, corrupted-save quarantine policy, and the pre-ship compatibility matrix
---

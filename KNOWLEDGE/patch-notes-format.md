---
name: patch-notes-format
type: KNOWLEDGE
description: The Gladewick patch-notes template — section order, per-title voice notes, the balance-line shape, the never-ships list, and per-storefront length caps
---

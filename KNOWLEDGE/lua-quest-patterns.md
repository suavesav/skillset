---
name: lua-quest-patterns
type: KNOWLEDGE
description: House patterns for quest scripting in Kiln Lua — the state-machine skeleton, trigger cleanup, abandon handling, co-op edge cases, and the three classic footguns
---
